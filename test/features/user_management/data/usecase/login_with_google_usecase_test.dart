...
void main() {
  ...
  GetLoginWithGoogleUseCase? useCase;

  setUp(() {
    authRepository = MockAuthRepository();
    useCase = GetLoginWithGoogleUseCase(authRepository!);
  });
  ...
  GetLoginWithGoogleParams params = GetLoginWithGoogleParams(
  ...
  test('Success login with google usecase', () async {
    when(authRepository!.loginWithGoogle(params: params)).thenAnswer((_) async => Result(
          data: loginModel,
        ));
  ...
  test('fail login with google usecase', () async {
    when(authRepository!.loginWithGoogle(params: params)).thenAnswer((_) async => RemoteResult(error: error));
