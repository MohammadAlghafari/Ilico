...
class BaseResponseModel<Result extends BaseResultModel> {
  ...
  BaseResponseModel(
      {this.result, this.targetUrl, this.success, this.serverError, this.error, this.unAuthorizedRequest, this.bAbp});
  ...
  BaseResponseModel.fromJson(
    ...
    if (isLaravel) {
      ...
      if (json == null) {
        ...
        serverError = json['error'] != null ? ServerError.fromJson(json['error']) : null;
  ...
  void fromLaravelJson(Map<String, dynamic>? json, BaseError? error, dynamic fromJson) {
    if (json == null) {
      ...
      if (json['message'] != null) {
        ...
        serverError = ServerError(message: errorMessage, code: errorCode);
      } else {
        serverError = null;
      }
      this.error = error;
...
class ServerError extends BaseResultModel {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (validationErrors != null) {
      data['validationErrors'] = validationErrors!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
