...
class _CustomMarkerHelper extends StatefulWidget {
  final Widget markerWidgets;
  final Function(Uint8List) callback;

  const _CustomMarkerHelper({required this.markerWidgets, required this.callback});

  @override
  _CustomMarkerHelperState createState() => _CustomMarkerHelperState();
}

class _CustomMarkerHelperState extends State<_CustomMarkerHelper> with AfterLayoutMixin {
